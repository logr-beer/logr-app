            ...
            <div class="p-3 bg-gray-50 dark:bg-gray-800 rounded-lg space-y-2">
                <div class="flex items-center gap-3">
                    ...
                    @unless($demoMode)
                        ...
                        <button type="button" wire:click="testBotCheckin({{ $index }})" class="shrink-0 inline-flex items-center gap-1 px-2 py-1 bg-amber-600 text-white text-xs font-medium rounded hover:bg-amber-700 transition-colors" title="Send a sample check-in">
                        ...
                        <button type="button" wire:click="testBotInventory({{ $index }})" class="shrink-0 inline-flex items-center gap-1 px-2 py-1 bg-blue-600 text-white text-xs font-medium rounded hover:bg-blue-700 transition-colors" title="Send a sample inventory notification">
            ...
            <div class="flex items-center justify-between px-1">
                ...
                @unless($demoMode)
                    <div>
                        ...
                        @else
                            <a href="{{ route('discord.link') }}" class="text-xs text-indigo-500 hover:text-indigo-700 dark:hover:text-indigo-400 transition-colors">
                                Link Discord
                            </a>
                        @endif
                    </div>
