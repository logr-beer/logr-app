            ...
            <div class="p-3 bg-gray-50 dark:bg-gray-800 rounded-lg space-y-2">
                ...
                <div class="flex items-center gap-4 text-xs">
                    <label class="inline-flex items-center gap-1.5 cursor-pointer">
                        <input type="checkbox" wire:click="toggleBotPref('{{ $guildId }}', 'publish_checkins')" {{ !empty($botPrefs[$guildId]['publish_checkins']) ? 'checked' : '' }}
                    ...
                    <label class="inline-flex items-center gap-1.5 cursor-pointer">
                        <input type="checkbox" wire:click="toggleBotPref('{{ $guildId }}', 'publish_purchases')" {{ !empty($botPrefs[$guildId]['publish_purchases']) ? 'checked' : '' }}
                            class="rounded border-gray-300 dark:border-gray-600 text-indigo-500 focus:ring-indigo-500 dark:bg-gray-700" />
