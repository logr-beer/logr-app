...
>
    <button
        ...
        class="flex items-center gap-2 px-3 py-1.5 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg text-sm text-gray-700 dark:text-gray-300 focus:ring-amber-500 focus:border-amber-500 focus:ring-1 focus:outline-none transition-colors"
    >
        <span x-text="label" class="truncate"></span>

        {{-- Direction toggle --}}
        <span
            wire:click.stop="$set('{{ $directionField }}', '{{ $this->{$directionField} === 'asc' ? 'desc' : 'asc' }}')"
    ...
    <div
        ...
        class="absolute z-50 mt-1 w-full min-w-[8rem] bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-lg shadow-lg overflow-auto max-h-60 top-full"
    >
