                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    <div class="flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-gray-500 dark:text-gray-400">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <a href="https://logr.beer" target="_blank" rel="noopener" class="hover:text-gray-600 dark:hover:text-gray-300 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900 rounded-sm transition-colors">
                                logr.beer
                            </a>
                        </div>
                    </div>
